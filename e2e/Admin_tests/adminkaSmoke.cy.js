const server = 'https://autotest.pharmahrm.com/', userName = 'Administrator', password = 'isodmin';
const screenWidth = 1920, screenHight = 1080;
const language = 'Русский', firstSearchName = 'autotest', secondSearchName = 'autotest_COPY2';
...
describe("Smoke test Adminka", () => {
    ...
    it('Isnowork testing in hierarchy', () => {
        ...
        cy.get('#profile > h4', { timeout: 10000 })
            .should('be.visible')
            .and('have.text', 'User not selected');
